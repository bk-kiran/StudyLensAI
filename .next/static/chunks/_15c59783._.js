...
_s(CreateCourseDialog, "B+aarL2rK4NEtohT3EgIL4Htz10=");
...
_s(CoursesList, "QbuRxjOwbW3+wcj4cI+P4fEVWjE=");
_c = CoursesList;
var _c;
...
_s(UploadFileDialog, "cz3B5sQOxlrekAnUFUPeMaA2gqY=");
_c = UploadFileDialog;
var _c;
...
function CourseFilesView({ course, onBack }) {
    _s();
    const [files, setFiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(mockFiles.filter({
        "CourseFilesView.useState": (f)=>f.courseId === course.id
    }["CourseFilesView.useState"]));
...
_s(CourseFilesView, "zmAIhvjzdQG50NcEsPeUGCH6e0U=");
_c = CourseFilesView;
var _c;
...
//# sourceMappingURL=_15c59783._.js.map